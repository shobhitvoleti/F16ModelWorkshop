...
if isfile(joinpath((@__DIR__) |> Base.dirname |> Base.dirname, "dyad", "VectorBlocks", "definitions.jl"))
  include(joinpath((@__DIR__) |> Base.dirname |> Base.dirname, "dyad", "VectorBlocks", "definitions.jl"))
end
