...
| `lef_rad`         |                          | --  |
"""
@component function F16PlantIO(; name = nothing, npos_init=Float64(0.0), epos_init=Float64(0.0), alt_init=Float64(1000.0), phi_init=Float64(0.0), theta_init=-0.017, psi_init=Float64(0.0), vt_init=152.4, alpha_init=-0.017, beta_init=Float64(0.0), P_init=Float64(0.0), Q_init=Float64(0.0), R_init=Float64(0.0), kwargs...)
  ...
  __ovr_Cx_tot__guess = pop!(__overrides, "Cx_tot__guess", nothing)
  ...
  __ovr_Cy_tot__guess = pop!(__overrides, "Cy_tot__guess", nothing)
  ...
  __ovr_Cz_tot__guess = pop!(__overrides, "Cz_tot__guess", nothing)
  ...
  __ovr_Cl_tot__guess = pop!(__overrides, "Cl_tot__guess", nothing)
  ...
  __ovr_Cm_tot__guess = pop!(__overrides, "Cm_tot__guess", nothing)
  ...
  __ovr_Cn_tot__guess = pop!(__overrides, "Cn_tot__guess", nothing)
  ...
  __ovr_alpha_rad__guess = pop!(__overrides, "alpha_rad__guess", nothing)
  ...
  __ovr_beta_rad__guess = pop!(__overrides, "beta_rad__guess", nothing)
  ...
  isnothing(__ovr_Cx_tot__guess) || (__guesses[Cx_tot] = __ovr_Cx_tot__guess)
  isnothing(__ovr_Cy_tot__guess) || (__guesses[Cy_tot] = __ovr_Cy_tot__guess)
  isnothing(__ovr_Cz_tot__guess) || (__guesses[Cz_tot] = __ovr_Cz_tot__guess)
  isnothing(__ovr_Cl_tot__guess) || (__guesses[Cl_tot] = __ovr_Cl_tot__guess)
  isnothing(__ovr_Cm_tot__guess) || (__guesses[Cm_tot] = __ovr_Cm_tot__guess)
  isnothing(__ovr_Cn_tot__guess) || (__guesses[Cn_tot] = __ovr_Cn_tot__guess)
  ...
  isnothing(__ovr_alpha_rad__guess) || (__guesses[alpha_rad] = __ovr_alpha_rad__guess)
  isnothing(__ovr_beta_rad__guess) || (__guesses[beta_rad] = __ovr_beta_rad__guess)
  ...
  push!(__eqs, Q_out ~ Q)
  push!(__eqs, R_out ~ R)
  push!(__eqs, el_rad ~ el * 3.14159265359 / 180.0)
  push!(__eqs, ail_rad ~ ail * 3.14159265359 / 180.0)
  push!(__eqs, rud_rad ~ rud * 3.14159265359 / 180.0)
  push!(__eqs, lef_rad ~ lef * 3.14159265359 / 180.0)
  ...
  push!(__eqs, Cx_tot ~ Cx0 + Cxa * alpha_rad + Cxa2 * alpha_rad * alpha_rad + Cxde * el_rad + Cxq * (cbar * Q / (2.0 * vt)))
  push!(__eqs, Cy_tot ~ Cy0 + Cyb * beta_rad + Cyda * ail_rad + Cydr * rud_rad + Cyp * (B * P / (2.0 * vt)) + Cyr * (B * R / (2.0 * vt)))
  push!(__eqs, Cz_tot ~ Cz0 + Cza * alpha_rad + Cza2 * alpha_rad * alpha_rad + Czde * el_rad + Czq * (cbar * Q / (2.0 * vt)))
  push!(__eqs, Cl_tot ~ Cl0 + Clb * beta_rad + Clda * ail_rad + Cldr * rud_rad + Clp * (B * P / (2.0 * vt)) + Clr * (B * R / (2.0 * vt)))
  push!(__eqs, Cm_tot ~ Cm0 + Cma * alpha_rad + Cma2 * alpha_rad * alpha_rad + Cmde * el_rad + Cmq * (cbar * Q / (2.0 * vt)))
  push!(__eqs, Cn_tot ~ Cn0 + Cnb * beta_rad + Cnda * ail_rad + Cndr * rud_rad + Cnp * (B * P / (2.0 * vt)) + Cnr * (B * R / (2.0 * vt)))
